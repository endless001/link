(function ( root, factory ) {
	...
	var AvatarUpload = function(config) {
		...
		this.imageWrapper = this.el.querySelector('.avatar-upload-image-wrapper');
	};
	...
	AvatarUpload.prototype.renderInput = function() {
		...
		el.className = 'avatar-upload-shell';

		el.innerHTML = [
			'<div class="avatar-upload-wrapper avatar-upload-complete">',
				'<div class="avatar-upload-image-wrapper">',
					'<img src="'+img+'">',
				'</div>',
				'<img src="'+img+'" class="avatar-upload-faded-image">',
				'<div class="avatar-upload-progress-wrapper">',
					'<span>0%</span>',
				'</div>',
				'<input type="file">',
			'</div>',
	...
	AvatarUpload.prototype.uiUploadStart = function(img) {
		...
		this.el.querySelector('.avatar-upload-wrapper').className = 'avatar-upload-wrapper'; // remove complete class
	};
	...
	AvatarUpload.prototype.uiUploadSuccess = function(xhr, json) {
		...
		this.el.querySelector('.avatar-upload-wrapper').className = 'avatar-upload-wrapper avatar-upload-complete';
	};
