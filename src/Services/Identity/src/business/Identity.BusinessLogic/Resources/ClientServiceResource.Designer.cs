...
namespace Identity.BusinessLogic.Resources {
    ...
    internal class ClientServiceResource {
        ...
        /// <summary>
        ///   查找类似 Client claim with id {0} doesn&apos;t exist 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Client with id {0} doesn&apos;t exist 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Client already exists 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Client Id ({0}) already exists 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Client property with id {0} doesn&apos;t exist 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Client secret with id {0} doesn&apos;t exist 的本地化字符串。
        /// </summary>
